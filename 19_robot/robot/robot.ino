/**
  Simplesketch to control a robot equipped with a HC-SR04 distance sensor and two DC motors wired to a L293D motor driver.

  For connections see the circuit diagram in the same folder.
*/
